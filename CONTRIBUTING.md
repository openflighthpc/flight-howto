# Contributing to FlightHowto

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to FlightHowto? Welcome! Please read this
...
You can help FlightHowto by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-howto/issues?state=open)
...
If you find a bug - behaviour of FlightHowto code or documentation
...
[GitHub issue tracker for FlightHowto](https://github.com/openflighthpc/flight-howto/issues/new)
to report the issue.
...
We want to improve the quality of FlightHowto and good bug reports are
...
FlightHowto is Open Source and comes without warranty.
...
FlightHowto in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of FlightHowto and really improve it. The more
...
applied to FlightHowto itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-howto). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the FlightHowto developers also have their regular
